	            ...
	            <div >
	                <div class="row">
	                    <div class="col-md-6 left" id="contact_left">
	                        <img class="img-responsive" src="images/qna.png"  width="300px" height="300px">
	                    </div>	
	                    <div class="col-md-6 right" id="contact_right">
	                        ...
	                        <br>
	                        <!-- form -->
	                        <form class="form_edit" action="qna.amg" method="post"> 
 			...
 			<div>
				<table class="table table-hover">
					...
					<tr id="subject">
						<td>${list.num}</td>
						<td>${list.category}</td>
						<td width="50%" ><a href="qna_sub.amg?num=${list.num}" > ${list.q_subject}</a></td>
						<%-- <td width="50%" ><a href="${v_content }?num=${list.num}" > ${list.q_subject}</a></td> --%>
						<td>${list.regdate}</td>					
					</tr>	
					</c:forEach>
				</table>
