...
public class ServiceCenterController {
	...
	public String writeQna(QnADTO qna, RedirectAttributes rab) throws Exception {
		System.out.println("==========================writeQna===========================");
		service.insertQna(qna);
		
		rab.addFlashAttribute("success", "success");
		
		return "redirect:/qna/qna.amg";
	}
	...
	@RequestMapping("/freQuestion.amg")
	public String faq() throws Exception {
		logger.info("==========================================================================check");
		return "/qna/fre_question";
	}
}
