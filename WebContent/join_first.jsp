...
<style>
	...
	#join_form > .article:first-child{
		border-bottom: 1px solid rgba(70,65,61,.4);
	}
	
	#join_form > .article:first-child > .agree{
		margin-top:10px;
	}
	.article{
		width:100%;
	...
	.fa:hover{
		color: rgba(55,190,52,.7);
	}
	.important{
		font-weight: 700;
		color: rgba(50,70,250,.8);
	}
	...
	<div id="content">
		...
		<form method="post" id="join_form" name="join_form" action="">
			<div class="article">
				...
				<div class="agree">
					amiGo 서비스 이용약관, 위치정보,개인정보 수집 및 이용에 모두 동의합니다.
				</div>	
			</div>
			...
			<div class="article">
				...
				<div class="agree">
					amiGo 서비스 이용약관 동의<span class="important">(필수)</span>
				</div>
				<textarea rows="20" cols="110" readonly="readonly">
제1장 총칙

제 1 조 (목적)

이 약관은 amiGo ("회사" 또는 "amiGo")가 제공하는 amiGo 및 amiGo 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
	
제 2 조 (정의)

이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 amiGo 및 amiGo 관련 제반 서비스를 의미합니다.
...
- 게시중단요청서비스 : http://help.amiGo.com/claim_main.asp
...
③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다.</textarea>
			...
			<div class="article">
				...
				<div class="agree">
					amiGo 개인정보 수집및 이용동의<span class="important">(필수)</span>
				</div>
				<textarea rows="20" cols="110" readonly="readonly">
개인정보 수집 및 이용

1. 개인정보의 수집
(주)amiGo코리아(이하 '회사')는 게임 서비스 운영을 위해 아래와 같이 이용자의 개인정보를 수집하고 있습니다.
1) 온라인 서비스
...
그 밖의 사항은 개인정보처리방침에 따릅니다.
			...
			<div class="article">
				<i class="fa fa-check-circle-o" id="third-check" aria-hidden="true"></i>
				<div class="agree">
					amiGo 위치정보 이용약관 동의<span class="important">(필수)</span>
				</div>
				<textarea rows="20" cols="110" readonly="readonly">
위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 amiGo 위치기반 서비스를 이용할 수 있습니다.

제 1 조 (목적)
이 약관은 amiGo 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
상호: amiGo 주식회사
주소: 서울시 강남구 테헤란로 amiGo
전화번호: 1588-3820
이메일 주소: amiGocc@amiGo.com
부칙
제1조 시행일
